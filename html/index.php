        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <li>
                        <a class="profile-pic" href="#"> <img src="../img/fotoku.jpg" alt="user-img" width="36" class="img-circle"><b class="hidden-xs">Raihan</b></a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <div class="col-lg-3 col-sm-6 col-xs-12">
                        <div class="white-box analytics-info">
                            ...
                            <ul class="list-inline two-part">
                                ...
                                <li class="text-right"><i class="ti-arrow-up text-danger"></i> <span class="counter text-danger">911</span></li>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 col-xs-12">
                        <div class="white-box analytics-info">
                            ...
                            <ul class="list-inline two-part">
                                ...
                                <li class="text-right"><i class="ti-arrow-up text-success"></i> <span class="counter text-success">911</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
